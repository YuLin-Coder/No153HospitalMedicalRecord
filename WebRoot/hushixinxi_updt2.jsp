...
<link rel="stylesheet" href="images/hsgcommon/common.css" type="text/css">
	...
	<body>
			<form action="updateHushixinxi2.do" name="form1" method="post">
				      <table width="100%" border="1" align="center" cellpadding="3" cellspacing="1"  style="border-collapse:collapse" bgcolor="#F2FDFF">
						<tr bgcolor="#E7E7E7">
							<td height="20" colspan="2" background="images/table_header.gif">修改护士信息<input type="hidden" name="id" value="${hushixinxi.id}" /></td>
						</tr>
						...
						<script language="javascript">document.form1.hushigonghao.value='${hushixinxi.hushigonghao}';</script>	<script language="javascript">document.form1.mima.value='${hushixinxi.mima}';</script>	<script language="javascript">document.form1.hushixingming.value='${hushixinxi.hushixingming}';</script>	<script language="javascript">document.form1.xingbie.value='${hushixinxi.xingbie}';</script>	<script language="javascript">document.form1.dianhua.value='${hushixinxi.dianhua}';</script>	<script language="javascript">document.form1.shenfenzheng.value='${hushixinxi.shenfenzheng}';</script>	<script language="javascript">document.form1.beizhu.value='${hushixinxi.beizhu}';</script>	
					 </table>
			</form>
   </body>
</html>
