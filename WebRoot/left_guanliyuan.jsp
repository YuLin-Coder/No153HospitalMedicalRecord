...
<dl class="custom">
			<dt onClick="changeImage()">医护人员管理<img src="images/left/select_xl01.png"></dt>
			<dd><a href="yishengxinxi_add.jsp" target="hsgmain">医生添加</a></dd>
<dd><a href="yishengxinxiList.do" target="hsgmain">医生查询</a></dd>
<dd><a href="hushixinxi_add.jsp" target="hsgmain">护士添加</a></dd>
<dd><a href="hushixinxiList.do" target="hsgmain">护士查询</a></dd>

		</dl>
<dl class="custom">
			<dt onClick="changeImage()">病人管理<img src="images/left/select_xl01.png"></dt>
			
<dd><a href="bingrenxinxiList.do" target="hsgmain">病人查询</a></dd>

		</dl>
<dl class="custom">
			<dt onClick="changeImage()">病历管理<img src="images/left/select_xl01.png"></dt>
			
<dd><a href="binglixinxiList.do" target="hsgmain">病历查询</a></dd>

		</dl>
<dl class="custom">
			<dt onClick="changeImage()">药品管理<img src="images/left/select_xl01.png"></dt>
			<dd><a href="yaopinxinxi_add.jsp" target="hsgmain">药品添加</a></dd>
<dd><a href="yaopinxinxiList.do" target="hsgmain">药品查询</a></dd>
