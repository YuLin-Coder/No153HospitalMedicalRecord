				...
				<td>
					<table width="100%" border="0" align="center" cellpadding="4" cellspacing="1" bgcolor="#aec3de">
						<tr align="left" bgcolor="#F2FDFF">
							<td height="30" colspan="17" background="images/table_header.gif">医生信息列表</td>
						</tr>
					</table>
				</td>
			</tr>
				...
				%>
                            <tr align="center" bgcolor="#FFFFFF">
                             ...
                             <td>${u.yishenggonghao}</td>    <td>${u.yishengxingming}</td>    <td>${u.mima}</td>    <td align='center' bgcolor='#ebf0f7'>${u.xingbie}</td>    <td>${u.zhicheng}</td>    <td>${u.suozaikeshi}</td>    <td>${u.zhuzhizhengzhuang}</td>    <td>${u.lianxidianhua}</td>    <td>${u.shenfenzheng}</td>        
                              ...
                              <td align="center"><a class="btn btn-info btn-small" href="doUpdateYishengxinxi.do?id=${u.id }">编辑</a>  <a class="btn btn-info btn-small" href="deleteYishengxinxi.do?id=${u.id }"
										onclick="{if(confirm('确定要删除吗?')){return true;}return false;}">删除</a> <a class="btn btn-info btn-small" href="yishengxinxiDetail.do?id=${u.id}">详细</a></td>
                            </tr>
                          </c:forEach>
                        </table></td>
						</tr>
