				...
				<td>
					<table width="100%" border="0" align="center" cellpadding="4" cellspacing="1" bgcolor="#aec3de">
						<tr align="left" bgcolor="#F2FDFF">
							<td height="30" colspan="17" background="images/table_header.gif">药品信息列表</td>
						</tr>
					</table>
				</td>
			</tr>
						...
						<tr align="left" >
							<td colspan="17">
								<form action="yaopinxinxiList.do" name="myform" method="post">
									查询   药品编号：<input name="yaopinbianhao" type="text" id="yaopinbianhao" class="form-control2" />  药品名称：<input name="yaopinmingcheng" type="text" id="yaopinmingcheng" class="form-control2" />  生产药厂：<input name="shengchanyaochang" type="text" id="shengchanyaochang" class="form-control2" />
				...
				%>
                            <tr align="center" bgcolor="#FFFFFF">
                             ...
                             <td>${u.yaopinbianhao}</td>    <td>${u.yaopinmingcheng}</td>    <td>${u.chengfen}</td>    <td>${u.zhuzhizhengzhuang}</td>    <td width='90' align='center' bgcolor='#ebf0f7'><a href='${u.tupian}' target='_blank'><img src='${u.tupian}' width=88 height=99 border=0 /></a></td>    <td>${u.shengchanyaochang}</td>    
                              ...
                              <td align="center"><a class="btn btn-info btn-small" href="doUpdateYaopinxinxi.do?id=${u.id }">编辑</a>  <a class="btn btn-info btn-small" href="deleteYaopinxinxi.do?id=${u.id }"
										onclick="{if(confirm('确定要删除吗?')){return true;}return false;}">删除</a> <a class="btn btn-info btn-small" href="yaopinxinxiDetail.do?id=${u.id}">详细</a></td>
                            </tr>
                          </c:forEach>
                        </table></td>
						</tr>
