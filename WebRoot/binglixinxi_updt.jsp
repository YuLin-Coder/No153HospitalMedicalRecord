...
function gows()
{
	document.location.href="binglixinxi_add.jsp?id=<%=id%>";
}
function hsgxia2shxurxu(nstr,nwbk)
{
	...
	<body>
			<form action="updateBinglixinxi.do" name="form1" method="post">
				      <table width="100%" border="1" align="center" cellpadding="3" cellspacing="1"  style="border-collapse:collapse" bgcolor="#F2FDFF">
						<tr bgcolor="#E7E7E7">
							<td height="30" colspan="2" background="images/table_header.gif">修改病历信息<input type="hidden" name="id" value="${binglixinxi.id}" /></td>
						</tr>
						...
						<script language="javascript">document.form1.zhanghao.value='${binglixinxi.zhanghao}';</script>	<script language="javascript">document.form1.xingming.value='${binglixinxi.xingming}';</script>	<script language="javascript">document.form1.shenfenzheng.value='${binglixinxi.shenfenzheng}';</script>	<script language="javascript">document.form1.chushengnianyue.value='${binglixinxi.chushengnianyue}';</script>	<script language="javascript">document.form1.dianhua.value='${binglixinxi.dianhua}';</script>	<script language="javascript">document.form1.bingshi.value='${binglixinxi.bingshi}';</script>	<script language="javascript">document.form1.bingzheng.value='${binglixinxi.bingzheng}';</script>	<script language="javascript">document.form1.zhenduan.value='${binglixinxi.zhenduan}';</script>	<script language="javascript">document.form1.zhiliaofangan.value='${binglixinxi.zhiliaofangan}';</script>	
					 </table>
			</form>
   </body>
</html>
