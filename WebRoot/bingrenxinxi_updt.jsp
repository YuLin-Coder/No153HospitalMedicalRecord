...
function hsgxia2shxurxu(nstr,nwbk)
{
	...
	<body>
			<form action="updateBingrenxinxi.do" name="form1" method="post">
				      <table width="100%" border="1" align="center" cellpadding="3" cellspacing="1"  style="border-collapse:collapse" bgcolor="#F2FDFF">
						<tr bgcolor="#E7E7E7">
							<td height="30" colspan="2" background="images/table_header.gif">修改病人信息<input type="hidden" name="id" value="${bingrenxinxi.id}" /></td>
						</tr>
						...
						<script language="javascript">document.form1.zhanghao.value='${bingrenxinxi.zhanghao}';</script>	<script language="javascript">document.form1.xingming.value='${bingrenxinxi.xingming}';</script>	<script language="javascript">document.form1.xingbie.value='${bingrenxinxi.xingbie}';</script>	<script language="javascript">document.form1.shenfenzheng.value='${bingrenxinxi.shenfenzheng}';</script>	<script language="javascript">document.form1.chushengnianyue.value='${bingrenxinxi.chushengnianyue}';</script>	<script language="javascript">document.form1.dianhua.value='${bingrenxinxi.dianhua}';</script>	<script language="javascript">document.form1.dizhi.value='${bingrenxinxi.dizhi}';</script>	<script language="javascript">document.form1.bingshi.value='${bingrenxinxi.bingshi}';</script>	<script language="javascript">document.form1.beizhu.value='${bingrenxinxi.beizhu}';</script>	
					 </table>
			</form>
   </body>
</html>
