	...
	<body>
			<form action="updateYaopinxinxi.do" name="form1" method="post">
				      <table width="100%" border="1" align="center" cellpadding="3" cellspacing="1"  style="border-collapse:collapse" bgcolor="#F2FDFF">
						<tr bgcolor="#E7E7E7">
							<td height="30" colspan="2" background="images/table_header.gif">修改药品信息<input type="hidden" name="id" value="${yaopinxinxi.id}" /></td>
						</tr>
						...
						<script language="javascript">document.form1.yaopinbianhao.value='${yaopinxinxi.yaopinbianhao}';</script>	<script language="javascript">document.form1.yaopinmingcheng.value='${yaopinxinxi.yaopinmingcheng}';</script>	<script language="javascript">document.form1.chengfen.value='${yaopinxinxi.chengfen}';</script>	<script language="javascript">document.form1.zhuzhizhengzhuang.value='${yaopinxinxi.zhuzhizhengzhuang}';</script>	<script language="javascript">document.form1.tupian.value='${yaopinxinxi.tupian}';</script>	<script language="javascript">document.form1.shengchanyaochang.value='${yaopinxinxi.shengchanyaochang}';</script>	
					 </table>
			</form>
   </body>
</html>
