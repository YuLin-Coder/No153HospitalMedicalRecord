...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<table width="100%" border="0" cellpadding="0" cellspacing="0">
				...
				<td>
					<table width="100%" border="0" align="center" cellpadding="4" cellspacing="1" bgcolor="#aec3de">
						<tr align="left" bgcolor="#F2FDFF">
							<td height="30" colspan="17" background="images/table_header.gif">护士信息列表</td>
						</tr>
					</table>
				</td>
			</tr>
			  ...
			  <table width="100%" border="1" align="center" cellpadding="4" cellspacing="1" bgcolor="#aec3de">
					...
					<tr align="right" bgcolor="#ebf0f7">
					  ...
					  <table width="100%" border="0" align="center" cellpadding="4" cellspacing="1" >
						<tr align="left" >
							<td colspan="17">
								<form action="hushixinxiList.do" name="myform" method="post">
									查询   护士工号：<input name="hushigonghao" type="text" id="hushigonghao" class="form-control2" />  护士姓名：<input name="hushixingming" type="text" id="hushixingming" class="form-control2" /> 性别：<select name='xingbie' id='xingbie' class="form-control2"><option value="">所有</option><option value="男">男</option><option value="女">女</option></select>  电话：<input name="dianhua" type="text" id="dianhua" class="form-control2" />
				...
				%>
                            <tr align="center" bgcolor="#FFFFFF">
                             ...
                             <td>${u.hushigonghao}</td>    <td>${u.mima}</td>    <td>${u.hushixingming}</td>    <td align='center' bgcolor='#ebf0f7'>${u.xingbie}</td>    <td>${u.dianhua}</td>    <td>${u.shenfenzheng}</td>        
                              ...
                              <td align="center"><a class="btn btn-info btn-small" href="doUpdateHushixinxi.do?id=${u.id }">编辑</a>  <a class="btn btn-info btn-small" href="deleteHushixinxi.do?id=${u.id }"
										onclick="{if(confirm('确定要删除吗?')){return true;}return false;}">删除</a> <a class="btn btn-info btn-small" href="hushixinxiDetail.do?id=${u.id}">详细</a></td>
                            </tr>
                          </c:forEach>
                        </table></td>
						</tr>
		 ...
		 <c:if test="${page.page>1}">
              <a href="hushixinxiList.do?page=1" >首页</a>
             <a href="hushixinxiList.do?page=${page.page-1 }"> 上一页</a>             </c:if>
    	     <c:if test="${page.page<page.totalPage}">
			<a href="hushixinxiList.do?page=${page.page+1 }">下一页</a>
			<a href="hushixinxiList.do?page=${page.totalPage }">末页</a>		    </c:if>		
	</c:if>
	</p>
